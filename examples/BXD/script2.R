...
GN318 <- read.csv(gzfile("GN318/GN318_MeanDataAnnotated_rev081815.txt.gz"), skip = 33, header = TRUE, sep="\t", colClasses="character")
GN318[1:10,]

highImpact <- readLines("genes.txt")


phenotypes <- GN318[which(GN318[,"Gene.Symbol"] %in% highImpact),]
