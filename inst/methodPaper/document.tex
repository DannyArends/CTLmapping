...
\section{Methodology}
  ...
  \begin{figure*}[ht]
    ...
    \subfigure[CTL profiles]{
      \includegraphics[keepaspectratio,scale=.3]{img/ctl_qtl.pdf}
      \label{subfiga}
    }
    \hspace{0.3cm}
    \subfigure[Traits x Traits interaction matrix]{
      \includegraphics[keepaspectratio,scale=.3]{img/ctl_pxp.pdf}
      \label{subfigb}
    }
    \hspace{0.3cm}
    \subfigure[Reconstructed network]{
      \includegraphics[keepaspectratio,scale=.2]{img/ctl_net.pdf}
      \label{subfigc}
    }
  \end{center}
  \begin{minipage}{7in}
